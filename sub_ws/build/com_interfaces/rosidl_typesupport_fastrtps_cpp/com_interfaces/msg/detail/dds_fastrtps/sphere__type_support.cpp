...
#include "com_interfaces/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const com_interfaces::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<com_interfaces::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &com_interfaces::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
