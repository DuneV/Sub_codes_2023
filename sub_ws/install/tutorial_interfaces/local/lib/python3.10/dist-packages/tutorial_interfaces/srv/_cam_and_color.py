...
class Metaclass_CamAndColor(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tutorial_interfaces.srv.CamAndColor')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from tutorial_interfaces.srv import _cam_and_color
...
class CamAndColor(metaclass=Metaclass_CamAndColor):
    from tutorial_interfaces.srv._cam_and_color import CamAndColor_Request as Request
    from tutorial_interfaces.srv._cam_and_color import CamAndColor_Response as Response
