...
#ifndef COM_INTERFACES__SRV__DETAIL__CAM_AND_COLOR__FUNCTIONS_H_
#define COM_INTERFACES__SRV__DETAIL__CAM_AND_COLOR__FUNCTIONS_H_
 ...
 * calls
 * com_interfaces__srv__CamAndColor_Request__init().
...
/**
 * It calls
 * com_interfaces__srv__CamAndColor_Request__fini()
 ...
 * com_interfaces__srv__CamAndColor_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * com_interfaces__srv__CamAndColor_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * com_interfaces__srv__CamAndColor_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_com_interfaces
...
/**
 * It calls
 * com_interfaces__srv__CamAndColor_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_com_interfaces
...
/**
 * It allocates the memory for the array and calls
 * com_interfaces__srv__CamAndColor_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_com_interfaces
...
/**
 * It calls
 * com_interfaces__srv__CamAndColor_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COM_INTERFACES__SRV__DETAIL__CAM_AND_COLOR__FUNCTIONS_H_
