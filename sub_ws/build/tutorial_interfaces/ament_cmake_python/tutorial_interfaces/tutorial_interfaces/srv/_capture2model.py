...
class Metaclass_Capture2model(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tutorial_interfaces.srv.Capture2model')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from tutorial_interfaces.srv import _capture2model
...
class Capture2model(metaclass=Metaclass_Capture2model):
    from tutorial_interfaces.srv._capture2model import Capture2model_Request as Request
    from tutorial_interfaces.srv._capture2model import Capture2model_Response as Response
