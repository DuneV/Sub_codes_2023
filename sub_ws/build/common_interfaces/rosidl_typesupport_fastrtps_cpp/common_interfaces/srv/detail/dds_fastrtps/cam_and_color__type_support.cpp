...
#include "common_interfaces/srv/detail/cam_and_color__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const common_interfaces::srv::CamAndColor_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  common_interfaces::srv::CamAndColor_Request & ros_message)
{
  // Member: cam
  cdr >> ros_message.cam;
...
{
  auto typed_message =
    static_cast<const common_interfaces::srv::CamAndColor_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<common_interfaces::srv::CamAndColor_Request *>(
    untyped_ros_message);
...
{
  return &common_interfaces::srv::typesupport_fastrtps_cpp::_CamAndColor_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, common_interfaces, srv, CamAndColor_Request)() {
  return &common_interfaces::srv::typesupport_fastrtps_cpp::_CamAndColor_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_common_interfaces
cdr_serialize(
  const common_interfaces::srv::CamAndColor_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: posx1
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  common_interfaces::srv::CamAndColor_Response & ros_message)
{
  // Member: posx1
  cdr >> ros_message.posx1;
...
{
  auto typed_message =
    static_cast<const common_interfaces::srv::CamAndColor_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<common_interfaces::srv::CamAndColor_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &common_interfaces::srv::typesupport_fastrtps_cpp::_CamAndColor_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, common_interfaces, srv, CamAndColor_Response)() {
  return &common_interfaces::srv::typesupport_fastrtps_cpp::_CamAndColor_Response__handle;
}
...
{
  return &common_interfaces::srv::typesupport_fastrtps_cpp::_CamAndColor__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, common_interfaces, srv, CamAndColor)() {
  return &common_interfaces::srv::typesupport_fastrtps_cpp::_CamAndColor__handle;
}
