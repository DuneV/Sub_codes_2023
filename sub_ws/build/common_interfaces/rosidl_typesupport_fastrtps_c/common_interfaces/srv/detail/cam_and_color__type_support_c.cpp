...
#include "common_interfaces/srv/detail/cam_and_color__rosidl_typesupport_fastrtps_c.h"
...
using _CamAndColor_Request__ros_msg_type = common_interfaces__srv__CamAndColor_Request;
...
size_t get_serialized_size_common_interfaces__srv__CamAndColor_Request(
  const void * untyped_ros_message,
...
static uint32_t _CamAndColor_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_common_interfaces__srv__CamAndColor_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_common_interfaces
size_t max_serialized_size_common_interfaces__srv__CamAndColor_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _CamAndColor_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_common_interfaces__srv__CamAndColor_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, common_interfaces, srv, CamAndColor_Request)() {
...
using _CamAndColor_Response__ros_msg_type = common_interfaces__srv__CamAndColor_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_common_interfaces
size_t get_serialized_size_common_interfaces__srv__CamAndColor_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CamAndColor_Response__ros_msg_type * ros_message = static_cast<const _CamAndColor_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_common_interfaces__srv__CamAndColor_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_common_interfaces
size_t max_serialized_size_common_interfaces__srv__CamAndColor_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _CamAndColor_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_common_interfaces__srv__CamAndColor_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, common_interfaces, srv, CamAndColor_Response)() {
...
// already included above
// #include "common_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "common_interfaces/srv/cam_and_color.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, common_interfaces, srv, CamAndColor)() {
