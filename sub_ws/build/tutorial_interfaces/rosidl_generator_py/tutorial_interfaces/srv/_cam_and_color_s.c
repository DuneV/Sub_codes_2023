...
bool tutorial_interfaces__srv__cam_and_color__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tutorial_interfaces.srv._cam_and_color.CamAndColor_Request", full_classname_dest, 58) == 0);
  }
  tutorial_interfaces__srv__CamAndColor_Request * ros_message = _ros_message;
  {  // cam
...
PyObject * tutorial_interfaces__srv__cam_and_color__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tutorial_interfaces.srv._cam_and_color");
...
ROSIDL_GENERATOR_C_EXPORT
bool tutorial_interfaces__srv__cam_and_color__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tutorial_interfaces.srv._cam_and_color.CamAndColor_Response", full_classname_dest, 59) == 0);
  }
  tutorial_interfaces__srv__CamAndColor_Response * ros_message = _ros_message;
  {  // posx1
