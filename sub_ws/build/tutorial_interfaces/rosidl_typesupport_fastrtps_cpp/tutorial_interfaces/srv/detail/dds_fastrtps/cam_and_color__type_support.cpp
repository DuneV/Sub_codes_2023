...
#include "tutorial_interfaces/srv/detail/cam_and_color__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tutorial_interfaces::srv::CamAndColor_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::srv::CamAndColor_Request & ros_message)
{
  // Member: cam
  cdr >> ros_message.cam;
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::srv::CamAndColor_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::srv::CamAndColor_Request *>(
    untyped_ros_message);
...
{
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_CamAndColor_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, CamAndColor_Request)() {
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_CamAndColor_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tutorial_interfaces
cdr_serialize(
  const tutorial_interfaces::srv::CamAndColor_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: posx1
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tutorial_interfaces::srv::CamAndColor_Response & ros_message)
{
  // Member: posx1
  cdr >> ros_message.posx1;
...
{
  auto typed_message =
    static_cast<const tutorial_interfaces::srv::CamAndColor_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tutorial_interfaces::srv::CamAndColor_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_CamAndColor_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, CamAndColor_Response)() {
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_CamAndColor_Response__handle;
}
...
{
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_CamAndColor__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, CamAndColor)() {
  return &tutorial_interfaces::srv::typesupport_fastrtps_cpp::_CamAndColor__handle;
}
