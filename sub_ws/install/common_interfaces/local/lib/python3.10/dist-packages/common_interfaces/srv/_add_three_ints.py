...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'common_interfaces.srv.AddThreeInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from common_interfaces.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from common_interfaces.srv._add_three_ints import AddThreeInts_Request as Request
    from common_interfaces.srv._add_three_ints import AddThreeInts_Response as Response
