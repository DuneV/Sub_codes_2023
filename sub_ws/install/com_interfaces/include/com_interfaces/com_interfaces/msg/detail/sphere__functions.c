...
com_interfaces__msg__Sphere__init(com_interfaces__msg__Sphere * msg)
{
  ...
  if (!geometry_msgs__msg__Point__init(&msg->center)) {
    com_interfaces__msg__Sphere__fini(msg);
    return false;
  }
  // radius
  return true;
...
com_interfaces__msg__Sphere__create()
{
  ...
  com_interfaces__msg__Sphere * msg = (com_interfaces__msg__Sphere *)allocator.allocate(sizeof(com_interfaces__msg__Sphere), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(com_interfaces__msg__Sphere));
  bool success = com_interfaces__msg__Sphere__init(msg);
  if (!success) {
...
com_interfaces__msg__Sphere__Sequence__init(com_interfaces__msg__Sphere__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  com_interfaces__msg__Sphere * data = NULL;

  if (size) {
    data = (com_interfaces__msg__Sphere *)allocator.zero_allocate(size, sizeof(com_interfaces__msg__Sphere), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = com_interfaces__msg__Sphere__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        com_interfaces__msg__Sphere__fini(&data[i - 1]);
      }
...
com_interfaces__msg__Sphere__Sequence__fini(com_interfaces__msg__Sphere__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      com_interfaces__msg__Sphere__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  com_interfaces__msg__Sphere__Sequence * array = (com_interfaces__msg__Sphere__Sequence *)allocator.allocate(sizeof(com_interfaces__msg__Sphere__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = com_interfaces__msg__Sphere__Sequence__init(array, size);
  if (!success) {
...
com_interfaces__msg__Sphere__Sequence__destroy(com_interfaces__msg__Sphere__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    com_interfaces__msg__Sphere__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
com_interfaces__msg__Sphere__Sequence__are_equal(const com_interfaces__msg__Sphere__Sequence * lhs, const com_interfaces__msg__Sphere__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!com_interfaces__msg__Sphere__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  com_interfaces__msg__Sphere__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(com_interfaces__msg__Sphere);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    com_interfaces__msg__Sphere * data =
      (com_interfaces__msg__Sphere *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!com_interfaces__msg__Sphere__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          com_interfaces__msg__Sphere__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!com_interfaces__msg__Sphere__copy(
