...
#include "common_interfaces/srv/detail/capture2model__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_common_interfaces
cdr_serialize(
  const common_interfaces::srv::Capture2model_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  common_interfaces::srv::Capture2model_Request & ros_message)
{
  // Member: input
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const common_interfaces::srv::Capture2model_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<common_interfaces::srv::Capture2model_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_common_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<common_interfaces::srv::Capture2model_Request>()
{
  return &common_interfaces::srv::typesupport_fastrtps_cpp::_Capture2model_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, common_interfaces, srv, Capture2model_Request)() {
  return &common_interfaces::srv::typesupport_fastrtps_cpp::_Capture2model_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_common_interfaces
cdr_serialize(
  const common_interfaces::srv::Capture2model_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: quantity
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  common_interfaces::srv::Capture2model_Response & ros_message)
{
  // Member: quantity
  cdr >> ros_message.quantity;
...
{
  auto typed_message =
    static_cast<const common_interfaces::srv::Capture2model_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<common_interfaces::srv::Capture2model_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &common_interfaces::srv::typesupport_fastrtps_cpp::_Capture2model_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, common_interfaces, srv, Capture2model_Response)() {
  return &common_interfaces::srv::typesupport_fastrtps_cpp::_Capture2model_Response__handle;
}
...
{
  return &common_interfaces::srv::typesupport_fastrtps_cpp::_Capture2model__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, common_interfaces, srv, Capture2model)() {
  return &common_interfaces::srv::typesupport_fastrtps_cpp::_Capture2model__handle;
}
